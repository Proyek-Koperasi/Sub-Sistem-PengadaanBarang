...
class C_barang extends CI_Controller {
	...
	public function validasi()
	{
		...
		$this->form_validation->set_rules('kategori_barang', 'Kategori Barang', 'trim');
		$this->form_validation->set_rules('stok_gudang', 'Stok Gudang', 'trim|required|numeric');
		$this->form_validation->set_rules('stok_toko', 'Stok Toko', 'trim|required|numeric');
		...
		$this->form_validation->set_rules('deskripsi', 'Deskripsi Barang', 'trim');
	...
	{
		$data['baranglist'] = $this->m_barang->get_barang_detail($id_barang);
