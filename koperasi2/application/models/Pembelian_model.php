...
class Pembelian_model extends CI_Model {
	...
	public function getByIddt($id)
	{
		$this->db->select("t_detail_pembelian.id_detail_pembelian,t_detail_pembelian.jumlah_barang,t_detail_pembelian.harga_satuan,t_detail_pembelian.subtotal,t_barang.nama_barang");
		$this->db->where('t_detail_pembelian.id_pembelian', $id);
		$this->db->join('t_barang', 't_detail_pembelian.id_barang=t_barang.id_barang');
		$data = $this->db->get('t_detail_pembelian');
		return $data->result();
